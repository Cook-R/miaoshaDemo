...
public class UserServiceImpl implements UserService {
    ...
    public void register(UserModel userModel) throws BusinessException {
        ...
        UserDO userDO = comvertFromModel(userModel);
    ...
    private UserDO comvertFromModel(UserModel userModel){
        if (userModel == null){
            return  null;
        }
    ...
    private UserModel comvertFromDataObject(UserDO userDO, UserPasswordDO userPasswordDO){
        if(userDO ==null){
            return null;
        }
